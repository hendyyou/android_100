...
public class ServiceFragment extends BaseFragment {
	...
	public void onResume() {
		...
		super.onResume();
		Boolean isLogin = Utils.Preference
				.getBooleanPref(getActivity(), Constants.DataFile.DefaultKey.APP_LOGIN_FLAG, false);

		if (!isLogin) {
			loginLayout.setVisibility(View.VISIBLE);
			logoutLayout.setVisibility(View.GONE);
			jiaBalanceTextView.setVisibility(View.GONE);
		} else {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		jiaBalanceHttpResponseHandler = new CustomerJsonHttpResponseHandler<JiaCoinBean>(getActivity()) {
			...
			public void processCallSuccess(JiaCoinBean outBean, String msg) {
				...
				if (outBean == null) {
					...
					jiaBalanceTextView.setText(getString(R.string.my_jiacoin) + outBean.getBalance() / 100);
				}
				jiaBalanceTextView.setVisibility(View.VISIBLE);
			}
		};
		...
		logOutJsonHttpResponseHandler = new CustomerJsonHttpResponseHandler<JsonNoneOutBean>(getActivity()) {
			...
			public void processCallSuccess(JsonNoneOutBean outBean, String msg) {
				// TODO Auto-generated method stub
				Utils.Preference.setBooleanPref(getActivity(), Constants.DataFile.DefaultKey.APP_LOGIN_FLAG, false);
				loginLayout.setVisibility(View.VISIBLE);
				logoutLayout.setVisibility(View.GONE);
				jiaBalanceTextView.setVisibility(View.GONE);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		loginLayout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Boolean isLogin = Utils.Preference.getBooleanPref(getActivity(),
						Constants.DataFile.DefaultKey.APP_LOGIN_FLAG, false);
				if (!isLogin) {
