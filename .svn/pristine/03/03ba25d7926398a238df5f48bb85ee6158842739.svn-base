...
//        /**
//         * 微信开放平台和商户约定的支付密钥，微信开放平台的支付专用签名串PaySignKey
...
//        /**
//         * 返回结果通知URL：http://test20.100jia.cn/servicehost/jsonrest/android/order/OrderPay/0/wxPayAppNotify
//         */
//        public static final String NOTIFY_URL = "http://test20.100jia.cn/servicehost/jsonrest/android/order/OrderPay/0/wxPayAppNotify";
    }
    ...
    public static final class ShopCartOrder {
        ...
        public final static String ORDER_CONSIGNEEADDRESSID = "orderVO.consigneeAddressId";
    ...
    public static final class NetWorkRequest {
         ...
         */
        public static final String COMMIT_ADDRESS_020 = "sys/ConsigneeAddress/0/createOrUpdateConsigneeAddress";
        //地址提交(创建或者修改)
        /**
         ...
         */
        public static final String USE_CON_CODE_URL_039 = "order/OrderPay/0/useConCode";
        /**
         * 012：取消优惠码接口：order/Order/0/cancelConCode
         */
        public static final String CANCEL_CON_CODE_URL_012 = "order/OrderPay/0/cancelConCode";
        /**
         * 040：使用加币接口：order/Order/0/useJiaMoney
         */
        public static final String USE_JIA_MONEY_URL_040 = "order/OrderPay/0/useJiaMoney";
        /**
         * 041：取消加币接口：order/Order/0/cancelJiaMoney
         */
        public static final String CANCEL_JIA_MONEY_URL_041 = "order/OrderPay/0/cancelJiaMoney";
        /**
         * 051：加币优惠券支付接口：order/OrderPay/0/payForJiaMoneyOrConCode
         */
        public static final String PAY_FOR_JIA_MONEY_OR_COUPON_URL_051 = "order/OrderPay/0/payForJiaMoneyOrConCode";
        /**
         * 052：获取APP的微信支付请求信息接口：order/OrderPay/0/toWXPayForApp
         */
        public static final String TO_PAY_FOR_APP_URL_052 = "order/OrderPay/0/toWXPayForApp";
        /**
         * 053：生成预支付数据包信息接口：order/OrderPay/0/genProductArgs
         */
        public static final String GEN_PRODUCT_ARGS_URL_053 = "order/OrderPay/0/genProductArgs";
        /**
         * 054：生成微信支付PayReq接口：order/OrderPay/0/genSendPayReq
         */
        public static final String GEN_SEND_PAY_REQ_URL_054 = "order/OrderPay/0/genSendPayReq";
    }
    ...
    public static final class ArgName {
        ...
        public static final class Request {
            ...
            public static final class UseOrCancelJiaCoin {
                ...
                public static final String ORDER_ID = "orderId";
                /**
                 * 加币使用个数：jiaCurrencyUsedCount
                 */
                public static final String JIA_CURRENCY_USED_COUNT = "jiaCurrencyUsedCount";
                /**
                 * 优惠码：conCode
                 */
                public static final String CON_CODE = "conCode";
            ...
            public static final class PayForJiaCoinOrCoupon {
                /**
                 * 订单Id：orderId
                 */
                public static final String ORDER_ID = "orderId";
                ...
                public static final String CON_CODE = "conCode";
                /**
                 * 优惠金额：preferentialAmt
                 */
                public static final String PREFERENTIAL_AMT = "preferentialAmt";
            }

            public static final class GenProductArgs {
                /**
                 * 订单Id：orderId
                 */
                public static final String ORDER_ID = "orderId";
            ...
            public static final class GenSendPayReq {
                /**
                 * 微信订单Id：prepayId
                 */
