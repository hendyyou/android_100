...
public class CouponListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.couponDenominationView.setText(mContext.getString(R.string.order_list_rmb)
				+ Utils.Money.MoneyToYuan(cobean.getAmount()));
		viewHolder.couponStatusView.setText(cobean.getStateText());
		viewHolder.couponUseView.setText(cobean.getPurposeText());
		viewHolder.couponUseLimitView.setText(mContext.getString(R.string.order_list_rmb)+Utils.Money.MoneyToYuan(cobean.getUseCondition()));
		...
		viewHolder.contentLayoutView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
					...
					clipboard.setText(cobean.getConNo());
				}
