	...
	public void onCreate(Bundle savedInstanceState) {
		...
		orderHttpResponseHandler = new CustomerJsonHttpResponseHandler<OrderDetailBean>(getActivity()) {
			...
			public void processCallSuccess(OrderDetailBean outBean, String msg) {
				...
				ordfeeTextView.setText(getString(R.string.order_list_rmb)
						+ Utils.Money.MoneyToYuan(orderDetailBean.getProductPriceAmt() + orderDetailBean.getTransCost()));
				orderStatusView.setText(orderDetailBean.getOrderStatusName());
				payFeeView.setText(getString(R.string.order_submit_pay_title) + getString(R.string.order_list_rmb)
				...
				orderProductListView
						.setAdapter(new OrderProductListAdapter(getActivity(), orderDetailBean.getOrderItemVOs()));
				...
				if (orderDetailBean.getOrderStatus() != PAYED) {
					// 如果已经付了款了
					payBtn.setText(orderDetailBean.getOrderStatusName());
					payBtn.setEnabled(false);
				} else {
					payBtn.setText(getString(R.string.go_to_pay));
	...
	public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle) {
		...
		payBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				getBaseActivity().showFragment("order_pay_fragment", bundle, true);
			}
		});
